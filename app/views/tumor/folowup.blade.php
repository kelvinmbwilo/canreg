...
@section('contents')
{{ Form::open(array("url"=>"patient/add/tumor/{$patient->id}","class"=>"form-horizontal","id"=>"FileUploader")) }}
<h4 class="text-center">{{ $patient->first_name }} {{ $patient->middle_name }} {{ $patient->last_name }} </h4>
<div class="col-xs-12">
    <div class="col-sm-8">
    ...
    $(document).ready(function (){
        ...
        $("#submitbtn").unbind("click").click(function(){
            ...
            $("#FileUploader").ajaxSubmit({
                url:"<?php echo url("patient/register/tumor/{$patient->id}") ?>",
                target: '#output1',
