...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class='form-group'>
            ...
            <div class='col-sm-6'>
                Middle Name<br> {{ Form::text('middlename',$user->middle_name,array('class'=>'form-control','placeholder'=>'Middle Name')) }}
            </div>
        </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-sm-6'>
                Email/Username<br> {{ Form::text('email',$user->email,array('class'=>'form-control','placeholder'=>'Email/Username','required'=>'required')) }}
            </div>
        </div>
